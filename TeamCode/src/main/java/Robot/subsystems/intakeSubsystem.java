...
public class intakeSubsystem extends SubsystemBase {
  ...
  public void closeClawTele() {
    this.intClaw.setServoPos(intClawCloseTele);
  }
  ...
  public void setIntPivotSub() {
    this.intPivot.setServoPos(intPivotSub);
  }

  public void setIntPivotObs() {
    this.intPivot.setServoPos(intPivotObs);
  }

  public void setIntPivotObsAuto() {
    this.intPivot.setServoPos(intPivotObsAuto);
  }

  public void setIntPivotObsUp() {
    this.intPivot.setServoPos(intPivotSub + .025);
  }

  public void setIntPivotTransfer() {
    this.intPivot.setServoPos(intPivotTransfer);
  }
