...
public class constants{
    ...
    public static double out4BarPivot1Transfer = 0.54, out4BarPivot1HighChamber = .8, out4BarPivot1LowChamber = 0,out4BarPivot1LowBasket = 0,out4BarPivot1HighBasket = .8;
    ...
    public static double out4BarPivot1Start = 0.3, intClawPivotStart = .7,intPivotStart = 0.65;
    ...
    public static double intViperZero = -1, intViperTransfer = 0, intViperSub = 10, intViperObs = 10; //max 10in
