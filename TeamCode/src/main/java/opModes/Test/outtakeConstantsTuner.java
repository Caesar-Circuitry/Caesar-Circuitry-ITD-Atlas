...
public class outtakeConstantsTuner extends CommandOpMode {
  ...
  public void initialize() {
    ...
    driver
        ...
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.openClaw()));
    driver
        .getGamepadButton(GamepadKeys.Button.B)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.closeClaw()));
    driver
        .getGamepadButton(GamepadKeys.Button.X)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setOut4BarPivotHighBasket()));
    driver
        .getGamepadButton(GamepadKeys.Button.Y)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setOut4BarPivotHighChamber()));
    driver
        .getGamepadButton(GamepadKeys.Button.DPAD_UP)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setOut4BarPivotLowBasket()));
    driver
        .getGamepadButton(GamepadKeys.Button.DPAD_LEFT)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setOut4BarPivotLowChamber()));
    driver
        .getGamepadButton(GamepadKeys.Button.DPAD_RIGHT)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setOut4BarPivotTransfer()));
    driver
        .getGamepadButton(GamepadKeys.Button.DPAD_DOWN)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setOutClawPivotBasket()));
    operator
        .getGamepadButton(GamepadKeys.Button.A)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setOutClawPivotChamber()));
    operator
        .getGamepadButton(GamepadKeys.Button.B)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setOutClawPivotTransfer()));
    operator
        .getGamepadButton(GamepadKeys.Button.X)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setVertSlideHighBasket()));
    operator
        .getGamepadButton(GamepadKeys.Button.Y)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setVertSlideHighChamber()));
    operator
        .getGamepadButton(GamepadKeys.Button.DPAD_UP)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setVertSlideLowBasket()));
    operator
        .getGamepadButton(GamepadKeys.Button.DPAD_DOWN)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setVertSlideLowChamber()));
    operator
        .getGamepadButton(GamepadKeys.Button.DPAD_LEFT)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setVertSlideTransfer()));
    operator
        .getGamepadButton(GamepadKeys.Button.DPAD_RIGHT)
        .whenPressed(new InstantCommand(() -> robot.outtakeSubsystem.setVertSlideZero()));
