...
public class intakePIDTuner extends LinearOpMode {
    ...
    public static double horzSlideTargetPos = 0, horzSlideTargetVelocity = 5, horzSlideTargetAcceleration =5;
    ...
    private void setFeedBackPower(){
        ...
        motor.setPower(
                (viper.calculate(EncoderPos/ ticksPerInch, horzSlideTargetPos)*voltage)/voltageSensor.getVoltage()
        );
    }
}
