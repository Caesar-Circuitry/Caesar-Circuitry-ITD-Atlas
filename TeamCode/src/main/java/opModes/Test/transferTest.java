...
public class transferTest extends LinearOpMode {
  ...
  private double prevHorzMotorPower = 0,
      HorzMotorPower = 0,
      prevVertMotorPower = 0,
      VertMotorPower = 0;
  ...
  private void setFeedBackPower() {
    ...
    VertMotorPower =
        (vertViper.calculate(vertEncoderPos / vertTicksPerInch, vertSlideTargetPos) * voltage)
            / voltageSensorVoltage;
    ...
    horzSlide.setPower(
        (horzViper.calculate(horzEncoderPos / horzTickPerInch, horzSlideTargetPos) * voltage)
            / voltageSensorVoltage);
