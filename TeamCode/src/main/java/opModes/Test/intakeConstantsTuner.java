...
public class intakeConstantsTuner extends CommandOpMode {
    ...
    public void initialize() {
        ...
        driver.getGamepadButton(GamepadKeys.Button.X).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setIntClawPivotObs())
        );
        driver.getGamepadButton(GamepadKeys.Button.Y).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setIntClawPivotSub())
        );
        driver.getGamepadButton(GamepadKeys.Button.DPAD_UP).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setIntClawPivotTransfer())
        );
        driver.getGamepadButton(GamepadKeys.Button.DPAD_LEFT).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setIntClawRotateLeft())
        );
        driver.getGamepadButton(GamepadKeys.Button.DPAD_RIGHT).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setIntClawRotateMiddle())
        );
        driver.getGamepadButton(GamepadKeys.Button.DPAD_DOWN).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setIntClawRotateRight())
        );
        operator.getGamepadButton(GamepadKeys.Button.A).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setViperObs())
        );
        operator.getGamepadButton(GamepadKeys.Button.B).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setViperSub())
        );
        operator.getGamepadButton(GamepadKeys.Button.X).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setViperTransfer())
        );
        operator.getGamepadButton(GamepadKeys.Button.Y).whenPressed(
                new InstantCommand(() -> robot.intakeSubsystem.setViperZero())
        );
